...
load('tx_data_12_08_lg_7500_11.mat')
load('tx_data_12_08_s_7500_8_20.mat')
load('tx_data_12_08_s_15000_8_20.mat')
load('tx_data_12_08_s_15000_8_50.mat')
load('tx_data_12_08_s_30000_8_50.mat')
load('tx_data_12_08_short_period.mat')
...
Tx.data= [zeros(length(save_data_tx),1); save_data_tx; zeros(length(save_data_tx),1)];
